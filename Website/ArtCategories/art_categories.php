...
<main>
<div class="p-5">
<div class="row artCategories d-flex justify-content-center ">
<?php
if(mysqli_num_rows($result_category) > 0)
{
    while($row = mysqli_fetch_array($result_category))
    {
echo '<div class="artCategorie col-lg-2 col-md-2 col-sm-6 mb-5 justify-content-center text-center d-block ">';
